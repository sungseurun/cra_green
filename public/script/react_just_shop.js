...
function WrapComponent(){
  ...
  return(
    ...
    // 비구조화/구조분할 할당  const {homePath,logoTitle,imgSrc,imgAlt} = props;
    ...
    function HeaderComponent(props){
      ...
      // 상태관리 변수 addClass를 마우스가 클릭하면 true 상태변경
      // const onClickAddClass=(e)=>{
      //   e.preventDefault();
      //   alert('클릭!');
      //   setAddClass(true); //상태변경
      // }
      
      // // 상태관리 변수 addClass2 를 마우스를 클릭하면 false 상태변경
      ...
      // 메인버튼에 마우스 올리면 addClass를 true 상태변경
      // nav를 마우스 떠나면 addClass를 true 상태변경
          ...
          return(
            <section id="section2">
              ...
              <div className="center">
                <div className="title"><h2 style={{color:'rgb(95,0,128)', fontSize:'16px' , fontWeight:'700'}}>BANNER LINK</h2></div>
                <div className="img-box">
                  <a href="#" title="banner"><img src="./images/banner.jpg" alt="" /></a>
                </div>
              </div>
              <div className="right">
                <div className="title"><h2 style={{color:'rgb(95,0,128)', fontSize:'16px' , fontWeight:'700'}}>DIRECT LINK</h2></div>
                <div className="img-box">
...
// 2. 리액트돔은 루트 돔컨테이너(#root)와 컴포넌트를 연동시킨다.
